...
public class BarChart1_forRepositoryStatistics {
	ChartPanel frame1;
	public BarChart1_forRepositoryStatistics(int count_stamp, int size){
		CategoryDataset dataset = getDataSet(count_stamp,size);
	   ...
	   private static CategoryDataset getDataSet(int count_stamp, int size) {
...
//           }key
           dataset.addValue(count_stamp,"Project","项目总数");
           dataset.addValue(size,"Project","去重项目总数");
           return dataset;
}
