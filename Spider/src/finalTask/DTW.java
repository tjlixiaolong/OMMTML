...
//	private static final int num_of_frames2=5;
	...
	public static void generateFile(int row,String feature,String date)throws Exception{
		File directory = new File("E:\\projects\\projects20170403");
		String[] projectList = directory.list();
		File compareDirectory = new File("E:\\projects\\projects");
		String[] compareProjectList = compareDirectory.list();
		List<String> list = new ArrayList<String>();
		Map<String,String> mark1Map = MarkMap.getMark1Map();
		
		for(int i=0;i<projectList.length;i++){
			if(new File("E:\\projects\\projects20170403\\"+projectList[i]).isDirectory()) 
				continue;
			String featureRow1 = DataPrepared2.readTxtFile("E:\\projects\\projects20170403\\"+projectList[i],row);
			...
			for(int j=0;j<compareProjectList.length;j++){
				if(new File("E:\\projects\\projects\\"+compareProjectList[j]).isDirectory())
					continue;
				String featureRow2 = DataPrepared2.readTxtFile("E:\\projects\\projects\\"+compareProjectList[j],row);
