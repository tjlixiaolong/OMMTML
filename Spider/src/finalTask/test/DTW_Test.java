...
//	private static final int num_of_frames2=5;
	...
	public static void main(String[] args) throws ParseException {
		...
		String project = "pw2mw_projects.txt";
		String compareProject = "PiSpace_projects.txt";
		String commitRow1 = DataPrepared2.readTxtFile("E:\\projects\\"+project,2);
		String commitRow2 = DataPrepared2.readTxtFile("E:\\projects\\"+compareProject,2);
		...
		System.out.println(project+","+compareProject+"两个comment时间序列的最终DTW距离为："+ distance);
	}
